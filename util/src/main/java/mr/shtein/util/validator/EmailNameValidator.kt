...
class EmailNameValidator: Validator, EmptyFieldValidator() {
    ...
    override fun validateValue(valueForValidate: String): Boolean {
        return assertIsValidEmailName(valueForValidate)
    }

    private fun assertIsValidEmailName(value: String): Boolean {
